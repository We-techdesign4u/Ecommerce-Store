    ...
    <div className="w-screen h-screen space-y-6 flex justify-center items-center flex-col  pt-14">
      ...
      >
        ...
        <motion.g
          ...
          style={{ transformOrigin: "31px 37px" }}
        >
          <path
        ...
        <motion.g
          ...
          style={{ transformOrigin: "78px 21px" }}
        >
          <path
      ...
      <p className="text-[18px] text-center font-thin text-gray-400">
        Yeah, we are excited too. <br /> Kindly check in later
      </p>
    </div>
  );
};
